...
default['nc_tools']['package']     = '1'
default['nc_tools']['tool_name']   = '2'
default['nc_tools']['tool_ver']    = '3'
default['nc_tools']['tool_dir']    = '4'
default['nc_tools']['tool_inst']   = '5'
default['nc_tools']['tool_loc']    = '6'
