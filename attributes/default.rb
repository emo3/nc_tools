default['nc_tools']['package']     = 'nc81-probes.zip'
...
default['nc_tools']['media_dir']   = "#{node['nc_tools']['app_dir']}/media"
default['nc_tools']['install_dir'] = "#{node['nc_tools']['media_dir']}/ncp81"
